...
function showMaskTel() {
  document.addEventListener('DOMContentLoaded', function () {
    var phoneInputs = document.querySelectorAll('input[data-tel-input]'); // console.log(phoneInputs);
...
var btnDropDown = document.querySelector('.about-company__drop-down-btn'); // dropDownText.classList.add('is-hidden');
