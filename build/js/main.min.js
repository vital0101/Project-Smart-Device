...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_accordion_accordion__WEBPACK_IMPORTED_MODULE_2__["openAcc"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
...
var boxAcc = Array.from(document.querySelectorAll('.page-footer__accordion-wrapper')); // console.log(boxAcc);

function handlerClick(e) {
  e.preventDefault();
  var currentBox = e.target.closest('.page-footer__accordion-wrapper'); // console.log(currentBox);

  var currentContent = e.target.nextElementSibling; // console.log(currentContent);
